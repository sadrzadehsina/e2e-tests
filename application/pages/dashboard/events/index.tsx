                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {events.map((event) => (
                        <tr key={event.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="px-2 inline-flex text-xs leading-5 font-medium rounded-full whitespace-pre-wrap">
                              {event.description}
                            </span>
                          </td>
...
export async function getServerSideProps() {
  const eventRes = await fetch("http://localhost:3001/events");
